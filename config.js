...
module.exports = { 
    ...
    STICKER_PACKNAME: process.env.STICKER_PACKNAME || "ALPHA HUNTER'S PACK",
    STICKER_AUTHOR: process.env.STICKER_AUTHOR || "thendo",
    BOT_PRESENCE: process.env.BOT_PRESENCE || "available",
    REACT: process.env.REACT || false,
    READ_MESSAGE: process.env.READ_MESSAGE || "false",
    OWNER_NAME: process.env.OWNER_NAME || "Mudau Thendo",
    ...
    AUDIO_DATA: process.env.AUDIO_DATA || "ALPHA SOUND 🔊;😈",
    SUDO: process.env.SUDO || "233546703808",
    MODS: process.env.MODS || "233546703808,27728667702,233599715971,233557635112,2348068620970,263713115077",
    ...
    WELCOME_MESSAGE: process.env.WELCOME_MESSAGE ||  `@pp ∘₊✧──────✧₊∘
